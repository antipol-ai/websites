...
export const KARTEN = {
  ...
  "einfluss/omr": {"satz": "Das descope ich. Focus ist am Ende ein Leadership-Thema.", "wer": "Marketing Guru", "name": "Nicht mein Zirkus"},
  ...
  "schuld/omr": {"satz": "Nicht mein Bug, aber ich own den Fix. Nennt man Accountability.", "wer": "Marketing Guru", "name": "Wer hat's verbockt?"},
  ...
  "ernst/omr": {"satz": "Ich bin all in beim Craft und relaxed beim Noise.", "wer": "Marketing Guru", "name": "Guter Job, kaputter Laden"},
  ...
  "wahl/omr": {"satz": "Ich bin hier by choice, nicht by default.", "wer": "Marketing Guru", "name": "Ich bleib freiwillig"},
  ...
  "einzige/omr": {"satz": "Ich mache mich replaceable. Das ist echtes Enablement.", "wer": "Marketing Guru", "name": "Kein Held nötig"},
  ...
  "traegt/omr": {"satz": "Insight hab ich delivered, Ownership liegt bei euch. Bis EOB.", "wer": "Marketing Guru", "name": "Ich hab geliefert"},
